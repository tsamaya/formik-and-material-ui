...
import { FormControlLabel, FormLabel, Radio, TextField as MUITextField } from '@material-ui/core';
...
const UserFormFields = ({ movies, errors, touched, isSubmitting }) => {
    ...
    <FormLabel component="legend">Newsletter No <Field component={Switch} type="checkbox" value={'yes'} name="newsletter" /> Yes</FormLabel>
